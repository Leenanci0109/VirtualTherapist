...
(Frequency, array) = read('output1.wav') # Reading the sound file.
...
write("newoutput1.wav", Frequency, NewSound) # Saving it to the file.
...
write("newoutput2.wav", Frequency, newFilteredSignal) # Saving it to the file.
