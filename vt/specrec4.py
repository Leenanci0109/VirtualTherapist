...
checkpoint = ModelCheckpoint(r"E:\demo1\speeash7.h5", monitor='val_accuracy', save_weights_only=True, mode='max',
                             verbose=1,
                             save_best_only=True)
...
with open("E:\demo1\speeash7.json", "w") as json_file:  # 0-62% 6-60%
